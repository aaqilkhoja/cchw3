...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://mmdqw7r746.execute-api.us-east-1.amazonaws.com/cchw3-apistage';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'Content-Type', 'Accept', 'X-Amz-Meta-CustomLabels'], ['body']);
